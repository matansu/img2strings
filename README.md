# img2strings
An art project, weaving an image from a continous string. The original idea is not mine, but my imlementation is currently the state of the art in terms of appearance quality and running time (in my honest opinion). 
